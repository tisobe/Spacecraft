;;acistemp
x=mta_db_get(outfile='acistemp.fits',ter_cols='_1cbat_avg,_1cbbt_avg,_1crat_avg,_1crbt_avg,_1dactbt_avg,_1deamzt_avg,_1dpamyt_avg,_1dpamzt_avg,_1oahat_avg,_1oahbt_avg,_1pdeaat_avg,_1pdeabt_avg,_1pin1at_avg,_1wrat_avg,_1wrbt_avg')
dtrend,'acistemp.fits',wsmooth=30
x=mta_db_get(ter_cols='mtaacis..aciseleca_avg',outfile='aciseleca.fits')
dtrend,'aciseleca.fits',wsmooth=30
x=mta_db_get(ter_cols='mtaacis..aciselecb_avg',outfile='aciselecb.fits')
dtrend,'aciselecb.fits',wsmooth=30
x=mta_db_get(ter_cols='mtaacis..acismech_avg',outfile='acismech.fits')
...
;;ephrate
;x=mta_db_get(outfile='ephrate.fits',ter_cols='_sca00_avg,_sca01_avg,_sca02_avg,_sca03_avg,_sca04_avg,_sca05_avg,_scb00_avg,_scb01_avg,_scb02_avg,_scb04_avg,_scb05_avg,_scc0_avg,_scct1_avg,_scct2_avg,_scct3_avg,_scct4_avg,_scct5_avg,_scd0_avg,_sce0_avg,_scf0_avg,_scg0_avg,_sch25gr_avg,_sch25s1_avg,_sch25s23_avg,_sch41gr_avg,_sch41s1_avg,_sch41s23_avg,_sch4gr_avg,_sch4s1_avg,_sch4s23_avg,_sch8gr_avg,_sch8s1_avg,_sch8s23_avg,_scp25gr_avg,_scp25s_avg,_scp41gr_avg,_scp41s_avg,_scp4gr_avg,_scp4s_avg,_scp8gr_avg,_scp8s_avg')
...
;x=mta_db_get(ter_cols='mtahrc..hrchk_avg',outfile='hrchk.fits')
;dtrend,'hrchk.fits',wsmooth=10

;x=mta_db_get(ter_cols='mtapcad..pcadtemp_avg',outfile='pcadtemp.fits')
...
;dtrend,'pcadrwrate.fits',wsmooth=30
;x=mta_db_get(ter_cols='mtapcad..pcadgdrift_avg',outfile='pcadgdrift.fits')
;dtrend,'pcadgdrift.fits',wsmooth=30

;;simtemp
;x=mta_db_get(outfile='simtemp.fits',ter_cols='_3btu_bpt_avg,_3fabraat_avg,_3fabrcat_avg,_3famyzat_avg,_3fapyzat_avg,_3faralat_avg,_3flcabpt_avg,_3rctubpt_avg,_3tsmxcet_avg,_3tsmxspt_avg,_3tsmydpt_avg,_3tspyfet_avg,_3tspzdet_avg,_3tspzspt_avg,_3ttacs1t_avg,_3ttacs2t_avg,_3ttacs3t_avg,_3ttbrgbt_avg,_3tthrc1t_avg,_3tthrc2t_avg,_3tthrc3t_avg,_3ttralat_avg,_3ttralct_avg,_3ttvalvt_avg,_boxtemp_avg,_famtrtemp_avg,_flexatemp_avg,_flexatset_avg,_flexbtemp_avg,_flexbtset_avg,_flexctemp_avg,_flexctset_avg,_psutemp_avg,_tscmtrtemp_avg')
;dtrend,'simtemp.fits',wsmooth=10
;x=mta_db_get(ter_cols='mtasim..simelec_avg',outfile='simelec.fits')
;dtrend,'simelec.fits',wsmooth=10
;x=mta_db_get(ter_cols='mtasim..simactu_avg',outfile='simactu.fits')
...
;;sc_main_temp
;x=mta_db_get(outfile='sc_main_temp1.fits',ter_cols='_tape1pst_avg,_tape2pst_avg,_tapea1t_avg,_tapea2t_avg,_tasppcm_avg,_tasppcp_avg,_tasppcu_avg,_tasprwc_avg,_tcm_ctu_avg,_tcm_ifu_avg,_tcm_obc_avg,_tcm_pa1_avg,_tcm_pa2_avg,_tcm_pan_avg,_tcm_rfas_avg,_tcm_ssr1_avg,_tcm_ssr2_avg,_tcm_tx1_avg,_tcm_tx2_avg,_tcm_uso_avg,_tcylaft1_avg,_tcylaft2_avg,_tcylaft3_avg,_tcylaft4_avg,_tcylaft5_avg,_tcylaft6_avg,_tcylcmm_avg,_tcylfmzm_avg,_tcylfmzp_avg,_tcylpcm_avg,_tcylpcp_avg,_tcylrwc_avg,_tcyz_rw1_avg,_tcyz_rw6_avg')
;x=mta_db_get(outfile='sc_main_temp2.fits',ter_cols='_tep_bpan_avg,_tep_eia_avg,_tep_pcu_avg,_tep_ppan_avg,_tep_psu1_avg,_tep_psu2_avg,_tep_rctu_avg,_tfspcmm_avg,_tfspcmp_avg,_tfsppcm_avg,_tfsppcp_avg,_tfsppcu_avg,_tfsprwc_avg,_tmysada_avg,_tmzlgabm_avg,_tmzp_cnt_avg,_tmzp_my_avg,_tmzp_py_avg,_tpcm_rw4_avg,_tpcm_rw5_avg,_tpcp_rw2_avg,_tpcp_rw3_avg,_tpc_cea_avg,_tpc_dea_avg,_tpc_ese_avg,_tpc_fsse_avg,_tpc_pan_avg,_tpc_rctu_avg,_tpc_wda_avg,_tpysada_avg,_tpzlgabm_avg,_tsamyt_avg,_tsapyt_avg')
;dtrend,'sc_main_temp.fits',wsmooth=30
;x=mta_db_get(outfile='sc_anc_temp.fits',ter_cols='_tatecdpt_avg,_tatecdrt_avg,_tboltcut_avg,_tcnr_brm_avg,_tesh1_avg,_tesh2_avg,_tfssbkt1_avg,_tfssbkt2_avg,_tfutsupn_avg,_tmyhng_avg,_toxtsupn_avg,_trspmtpc_avg,_trspotep_avg,_trspotex_avg,_trspotpc_avg,_trsprwbb_avg,_trsprwbc_avg,_trsprwcm_avg,_tsciusf1_avg,_tsciusf2_avg,_tsciusf5_avg,_tsciusf8_avg,_tsctsf1_avg,_tsctsf2_avg,_tsctsf3_avg,_tsctsf4_avg,_tsctsf5_avg,_tsctsf6_avg')
;dtrend,'sc_anc_temp.fits',wsmooth=30
;x=mta_db_get(ter_cols='mtasubsys..batt_temp_avg',outfile='batt_temp.fits')
;dtrend,'batt_temp.fits',wsmooth=30
;x=mta_db_get(outfile='spcelec.fits',ter_cols='_ade1p5cv_avg,_ade2p5cv_avg,_ahknatpr_avg,_ahknatrd_avg,_avacmonv_avg,_avd1cv5v_avg,_avd2cv5v_avg,_awd1cv5v_avg,_awd1tqi_avg,_awd2cv5v_avg,_awd2tqi_avg,_awd3cv5v_avg,_awd3tqi_avg,_awd4cv5v_avg,_awd4tqi_avg,_awd5cv5v_avg,_awd5tqi_avg,_awd6cv5v_avg,_awd6tqi_avg,_cveep_avg,_cveer_avg,_edissnpr_avg,_elbi_avg,_elbv_avg,_epovspr_avg,_es1p5cv_avg,_es2p5cv_avg,_esamyi_avg,_esapyi_avg,_euvsenpr_avg,_obattpwr_avg,_ohrmapwr_avg,_oobapwr_avg')
;dtrend,'spcelec.fits',wsmooth=30
;;spceleca
;x=mta_db_get(outfile='spceleca.fits',ter_cols='_acpa5cv_avg,_aflc10ai_avg,_aflc11ai_avg,_aflc12ai_avg,_aflc13ai_avg,_aflc14ai_avg,_aflca1ai_avg,_aflca2ai_avg,_aflca3ai_avg,_aflca4ai_avg,_aflca5ai_avg,_aflca6ai_avg,_aflca7ai_avg,_aflca8ai_avg,_aflca9ai_avg,_aflcaah_avg,_aioap5cv_avg,_aovapwr_avg,_aspea5cv_avg,_c28vmona_avg,_ciua15v_avg,_ciua5v_avg,_cpa1pwr_avg,_cpa1v_avg,_cpa2pwr_avg,_cpa2v_avg,_cpca15v_avg,_cpca5v_avg,_crxav_avg,_csita15v_avg,_csita5v_avg,_cssr1cav_avg,_ctsa15v_avg,_ctsa5v_avg,_ctua15v_avg,_ctua5v_avg,_ctxapwr_avg,_ctxav_avg,_cusoa28v_avg,_cxo5voba_avg,_eiacvav_avg,_epa15v_avg')
;dtrend,'spceleca.fits',wsmooth=30
;;spcelecb
;x=mta_db_get(outfile='spcelecb.fits',ter_cols='_acpb5cv_avg,_aflc10bi_avg,_aflc11bi_avg,_aflc12bi_avg,_aflc13bi_avg,_aflc14bi_avg,_aflca1bi_avg,_aflca2bi_avg,_aflca3bi_avg,_aflca4bi_avg,_aflca5bi_avg,_aflca6bi_avg,_aflca7bi_avg,_aflca8bi_avg,_aflca9bi_avg,_aflcabh_avg,_aiobp5cv_avg,_aovbpwr_avg,_aspeb5cv_avg,_c28vmonb_avg,_ciub15v_avg,_ciub5v_avg,_cpcb15v_avg,_cpcb5v_avg,_crxbv_avg,_csitb15v_avg,_csitb5v_avg,_cssr2cbv_avg,_ctsb15v_avg,_ctsb5v_avg,_ctub15v_avg,_ctub5v_avg,_ctxbpwr_avg,_ctxbv_avg,_cusob28v_avg,_cxo5vobb_avg,_eiacvbv_avg,_epb15v_avg')
;dtrend,'spcelecb.fits',wsmooth=30

;;obaheaters
;x=mta_db_get(outfile='obaheaters1.fits',ter_cols='_oobthr01_avg,_oobthr02_avg,_oobthr03_avg,_oobthr04_avg,_oobthr05_avg,_oobthr06_avg,_oobthr07_avg,_oobthr08_avg,_oobthr09_avg,_oobthr10_avg,_oobthr11_avg,_oobthr12_avg,_oobthr13_avg,_oobthr14_avg,_oobthr15_avg,_oobthr16_avg,_oobthr17_avg,_oobthr18_avg,_oobthr19_avg,_oobthr20_avg,_oobthr21_avg,_oobthr22_avg,_oobthr23_avg,_oobthr24_avg,_oobthr25_avg,_oobthr26_avg,_oobthr27_avg,_oobthr28_avg,_oobthr29_avg,_oobthr30_avg,_oobthr31_avg,_oobthr32_avg')
;x=mta_db_get(outfile='obaheaters2.fits',ter_cols='_oobthr33_avg,_oobthr34_avg,_oobthr35_avg,_oobthr36_avg,_oobthr37_avg,_oobthr38_avg,_oobthr39_avg,_oobthr40_avg,_oobthr41_avg,_oobthr42_avg,_oobthr43_avg,_oobthr44_avg,_oobthr45_avg,_oobthr46_avg,_oobthr47_avg,_oobthr48_avg,_oobthr49_avg,_oobthr50_avg,_oobthr51_avg,_oobthr52_avg,_oobthr53_avg,_oobthr54_avg,_oobthr55_avg,_oobthr56_avg,_oobthr57_avg,_oobthr58_avg,_oobthr59_avg,_oobthr60_avg,_oobthr61_avg,_oobthr62_avg,_oobthr63_avg,_oobthr64_avg')
;dtrend,'obaheaters.fits',wsmooth=30
;x=mta_db_get(ter_cols='mtatel..obagrad_avg',outfile='obagrad.fits')
;dtrend,'obagrad.fits',wsmooth=30
;;hrmaheaters
;x=mta_db_get(outfile='hrmaheaters1.fits',ter_cols='_ohrthr01_avg,_ohrthr02_avg,_ohrthr03_avg,_ohrthr04_avg,_ohrthr05_avg,_ohrthr06_avg,_ohrthr07_avg,_ohrthr08_avg,_ohrthr09_avg,_ohrthr10_avg,_ohrthr11_avg,_ohrthr12_avg,_ohrthr13_avg,_ohrthr14_avg,_ohrthr15_avg,_ohrthr16_avg,_ohrthr17_avg,_ohrthr18_avg,_ohrthr19_avg,_ohrthr20_avg,_ohrthr21_avg,_ohrthr22_avg,_ohrthr23_avg,_ohrthr24_avg,_ohrthr25_avg,_ohrthr26_avg,_ohrthr28_avg,_ohrthr29_avg,_ohrthr30_avg,_ohrthr31_avg,_ohrthr32_avg')
;x=mta_db_get(outfile='hrmaheaters2.fits',ter_cols='_ohrthr33_avg,_ohrthr34_avg,_ohrthr35_avg,_ohrthr36_avg,_ohrthr37_avg,_ohrthr38_avg,_ohrthr39_avg,_ohrthr40_avg,_ohrthr41_avg,_ohrthr44_avg,_ohrthr45_avg,_ohrthr46_avg,_ohrthr47_avg,_ohrthr48_avg,_ohrthr49_avg,_ohrthr50_avg,_ohrthr51_avg,_ohrthr52_avg,_ohrthr53_avg,_ohrthr54_avg,_ohrthr55_avg,_ohrthr56_avg,_ohrthr57_avg,_ohrthr58_avg,_ohrthr59_avg,_ohrthr60_avg,_ohrthr61_avg,_ohrthr62_avg,_ohrthr63_avg,_ohrthr64_avg')
;dtrend,'hrmaheaters.fits',wsmooth=30
;x=mta_db_get(ter_cols='mtatel..hrmagrad_avg',outfile='hrmagrad.fits')
;dtrend,'hrmagrad.fits',wsmooth=30
...
;x=mta_db_get(ter_cols='mtatel..hrmastruts_avg',outfile='hrmastruts.fits')
;dtrend,'hrmastruts.fits',wsmooth=30
;x=mta_db_get(ter_cols='mtatel..obfwdbulkhead_avg',outfile='obfwdbulkhead.fits')
;dtrend,'obfwdbulkhead.fits',wsmooth=30
;x=mta_db_get(ter_cols='mtatel..precoll_avg',outfile='precoll.fits')
