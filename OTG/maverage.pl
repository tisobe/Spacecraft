...
#---------------------------------------------------------------------
#
#   maverage.pl: this is mups and elbi version of average.pl
#
#      copied from /data/mta/Script/RDB/MUPS/average.pl
#
...
#
        ...
        chomp $inline;
        @totarr    = split ("\t", $inline);
        $totarr[0] = &convert_time($totarr[0]);
        @tmparr    = [0,@totarr];
        $lasttime  = $totarr[0];
        $nelm      = $nelm + 1;
    }
