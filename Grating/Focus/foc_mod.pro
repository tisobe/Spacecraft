...
;
; x ticks are manually set. check around line 192, 244 and update every few years
;   ---- note added 03/27/18 TI
;
...
for j = 0, n_elements(label_list) - 1 do begin
  ...
  if (streak gt 0) then begin
    ...
    plot, timest, st10, psym = 1, xstyle=1, ystyle=1, charsize=csize, $
          ...
          xticks=6,xtickv=[63072063,157766463,252460863,347155263,441763197,536457596,631151994],xminor=12, $
          xtickname=[' 2000',' 2003',' 2006',' 2009',' 2012', ' 2015', ' 2018']
