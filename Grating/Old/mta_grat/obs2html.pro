...
spawn, "/usr/ucb/sed '1,/SUMMARY START/s/^/X/' index.html > xindex1"
spawn, "/usr/ucb/sed '/SUMMARY END/,$s/^/Y/' xindex1 > xindex2"
spawn, "grep '^X' xindex2 | /usr/ucb/sed 's/^X//' > index.html"
spawn, "cat out.html >> index.html"
spawn, "grep '^Y' xindex2 | /usr/ucb/sed 's/^Y//' >> index.html"
